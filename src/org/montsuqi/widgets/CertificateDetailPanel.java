...
/** <p>A component that shows details of a certificate.</p>
 * 
 * <p>On the left it holds the certificate chain list.
 * On top right the contents summary of the selected certificate and
 * on the bottom right detail of the selected element of the current certificate.</p>
 */
