 ...
 * 
 * <p>NotebookDummyButton is not displayed but can react on actions(by doClick()).</p>
 * 
 * <p>Its text label and enabled/disabled status is propagated to corresponding tab.</p>
 */
